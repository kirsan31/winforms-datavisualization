...
namespace System.Windows.Forms.DataVisualization.Charting
{
    ...
    public class AxisScrollBar : IDisposable
    {
        ...
        // Indicates that scrollbar will be drawn
        ...
        internal void Paint(ChartGraphics graph)
        {
            ...
            // Fill rectangle between to neighbor scroll bars
        ...
        /// <summary>
        /// Fills a connection rectangle between two scroll bars.
        /// </summary>
            ...
            int borderWidth)
        {
            ...
            // Check if scroll bar is shown on the left/right sides of
            ...
            ScrollBarButtonType buttonType)
        {
            ...
            switch (buttonType)
            {
                case ScrollBarButtonType.SmallDecrement:
                    {
                        // Calculate triangle points position
        ...
        /// Used to repeatedly scroll data scaleView while mouse button is pressed.
        /// </summary>
        ...
        #endregion Mouse events handling for the Scroll Bar
        ...
        private double GetDataViewPercentage()
        {
                ...
                !double.IsNaN(this.axis.ScaleView.Size))
            {
                ...
                // Check if data scaleView is smaller than axis scale and if it is find the percentage
        ...
        /// <summary>
        /// Returns the data scaleView position in percentage (0-100%) using
        /// the axis scale minimum and maximum values.
        /// </summary>
        ...
        #endregion Scroll bar helper methods
