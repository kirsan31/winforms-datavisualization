...
internal class AxisScaleSegment
{
    ...
    private const double _intervalOffset = 0;
...
#pragma warning disable CA1822 // Mark members as static
    public double IntervalOffset => _intervalOffset;
...
internal class AxisScaleSegmentCollection : CollectionBase
{
    ...
    public AxisScaleSegment this[int index] => (AxisScaleSegment)this.List[index];
