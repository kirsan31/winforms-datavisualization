...
public partial class ChartArea : ChartNamedElement, IDisposable
{
    ...
    internal void Paint(ChartGraphics graph)
    {
        ...
        if (!requireAxes && ChartTypes.Count != 0)
        {
            ...
            {
                IChartType chartType = Common.ChartTypeRegistry.GetChartType(ChartTypes[chartTypeIndex]);
