...
public partial class ChartGraphics : ChartElement, IDisposable
{
        ...
        )
    {
        ...
        // This prevents AntiAliasing from completely smoothing the
        // dashed line.
        ...
        )
    {
        ...
        // Draw image instead of standard markers
        ...
        int pointIndex)
    {
        ...
        if (!backPosition.IsEmpty)
        {
                ...
                common.ProcessModeRegions)
            {
                ...
                {
                    common.HotRegionsList.List[^1].Type =
        ...
        bool truncatedRight)
    {
        ...
        using (StringFormat drawingFormat = (StringFormat)format.Clone())
        {
            ...
            //********************************************************************
            //** Adjust rectangle for horizontal axis
            //********************************************************************
            ...
            //********************************************************************
            //** Reserve space on the left for the label image
            //********************************************************************
            ...
            //********************************************************************
            //** Make sure that one line label will not disappear with LineLimit
            //** flag on.
            //********************************************************************
            if ((drawingFormat.FormatFlags & StringFormatFlags.LineLimit) != 0)
            {
                ...
                // If height of one character is more than rectangle height - remove LineLimit flag
            ...
            else
            {
                ...
                // If height of one character is more than rectangle height - set NoClip flag
                if (size.Height > absPosition.Height)
                {
        ...
        bool isVertical)
    {
        ...
        // hight ca be extremely large. Drawing such a rectangle may cause an overflow exception.
        ...
        if (borderWidth > 0 && borderDashStyle != ChartDashStyle.NotSet)
        {
            ...
            if (circular)
            {
                this.DrawCircleAbs(Pen, null, rect, circularSectorsCount, false);
            }
            else
            {
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        {
            if (borderWidth > 1)
                this.DrawRectangle(Pen, rect.X, rect.Y, rect.Width + 1, rect.Height + 1);
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        ChartDashStyle borderDashStyle)
    {
        ...
        {
            borderTypeInterface.Resolution = this.Graphics.DpiX * Chart.DPIScale;
            // Draw border
