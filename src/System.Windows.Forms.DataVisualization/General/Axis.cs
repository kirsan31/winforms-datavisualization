...
#pragma warning restore CA2213 // Disposable fields should be disposed
    ...
    // Internal
    internal ChartArea ChartArea => Parent as ChartArea;
    ...
    public virtual AxisName AxisName => axisType;
    ...
    internal void DrawAxisLine(ChartGraphics graph, bool backElements)
    {
        ...
        if (Common.ProcessModePaint)
        {
            if (!ChartArea.Area3DStyle.Enable3D || ChartArea.chartAreaIsCurcular)
            {
                ...
                graph.StartHotRegion(this._url, ToolTip);
