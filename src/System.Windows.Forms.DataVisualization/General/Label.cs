...
namespace System.Windows.Forms.DataVisualization.Charting
{
    ...
    public class CustomLabelsCollection : ChartElementCollection<CustomLabel>
    {
        ...
        {
            Add(labelsStep, intervalType, 0, 0, string.Empty, 0, LabelMarkStyle.None);
        }
        ...
        private RectangleF GetAllLabelsRect(ChartArea area, AxisPosition position, StringFormat stringFormat)
        {
            ...
            if (position == AxisPosition.Left)
            {
                ...
                if (labelsAxis.GetIsMarksNextToAxis())
                {
                    ...
                    rectLabels.Width = Math.Max(rectLabels.Width, rectLabels.X - labelsAxis.PlotAreaPosition.X);
                }
                else
                {
            ...
            else if (position == AxisPosition.Right)
            {
                ...
                {
                    rectLabels.X = (float)labelsAxis.GetAxisPosition();
                    rectLabels.Width = Math.Max(rectLabels.Width, labelsAxis.PlotAreaPosition.Right - rectLabels.X);
                }
                else
                {
            ...
            else if (position == AxisPosition.Top)
            {
                ...
                if (labelsAxis.GetIsMarksNextToAxis())
                {
                    ...
                    rectLabels.Height = Math.Max(rectLabels.Height, rectLabels.Y - labelsAxis.PlotAreaPosition.Y);
                }
                else
                {
            ...
            else if (position == AxisPosition.Bottom)
            {
                ...
                {
                    rectLabels.Y = (float)labelsAxis.GetAxisPosition();
                    rectLabels.Height = Math.Max(rectLabels.Height, labelsAxis.PlotAreaPosition.Bottom - rectLabels.Y);
                }
                else
                {
