...
SRDescription("DescriptionAttributeTextFont4"),
    ...
    {
        get => base.LineColor; set => base.LineColor = value;
    }
    ...
    {
        get => base.LineDashStyle; set => base.LineDashStyle = value;
    }
    ...
    {
        get => base.BackHatchStyle; set => base.BackHatchStyle = value;
    }
    ...
    {
        get => base.BackGradientStyle; set => base.BackGradientStyle = value;
    }
    ...
    {
        get => base.BackSecondaryColor; set => base.BackSecondaryColor = value;
    }
    ...
    public void BeginTextEditing()
    {
        if (this.Chart != null && this.AllowTextEditing)
        {
            ...
            ChartGraphics gr = GetGraphics();
            if (gr is not null)
            {
                // Convert point to relative coordinates
                textPosition = gr.GetAbsoluteRectangle(textPosition);
            }
    ...
    internal override RectangleF GetContentPosition()
    {
        ...
        // Create temporary bitmap based chart graphics if chart was not rendered yet and the graphics was not created.
        Graphics graphics = null;
        Image graphicsImage = null;
        ChartGraphics tempChartGraph = null;
        ChartGraphics gr = GetGraphics();
        if (gr is null && this.Common is not null)
        {
    ...
    internal virtual RectangleF GetTextSpacing(out bool annotationRelative)
    {
        ...
        ChartGraphics gr = GetGraphics();
        if (gr is not null)
            rect = gr.GetRelativeRectangle(rect);
...
public class AnnotationSmartLabelStyle : SmartLabelStyle
{
    ...
    {
        get => base.CalloutStyle; set => base.CalloutStyle = value;
    }
    ...
    {
        get => base.CalloutLineColor; set => base.CalloutLineColor = value;
    }
    ...
    {
        get => base.CalloutLineDashStyle; set => base.CalloutLineDashStyle = value;
    }
    ...
    {
        get => base.CalloutBackColor; set => base.CalloutBackColor = value;
    }
    ...
    {
        get => base.CalloutLineWidth; set => base.CalloutLineWidth = value;
    }
    ...
    {
        get => base.CalloutLineAnchorCapStyle; set => base.CalloutLineAnchorCapStyle = value;
    }
