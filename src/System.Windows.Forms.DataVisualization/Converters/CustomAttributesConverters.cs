...
internal sealed class CustomPropertiesTypeConverter : TypeConverter
{
    ...
    private class CustomAttributesPropertyDescriptor : SimplePropertyDescriptor
    {
        ...
        private readonly CustomPropertyInfo _customAttributeInfo;
        ...
        public string GetStringFromValue(object value)
        {
            ...
            {
                return v1.ToString(System.Globalization.CultureInfo.InvariantCulture);
            }
            else if (value is int v2)
            {
                return v2.ToString(System.Globalization.CultureInfo.InvariantCulture);
            }
        ...
        public virtual void ValidateValue(string attrName, object value)
        {
            ...
            if (this._customAttributeInfo.MaxValue != null)
            {
                ...
                if (value is float v)
                {
                    if (v > (float)this._customAttributeInfo.MaxValue)
                    {
                        outOfRange = true;
                    }
                }
                ...
                {
                    if (v1 > (double)this._customAttributeInfo.MaxValue)
                    {
                        outOfRange = true;
                    }
                }
                ...
                {
                    if (v2 > (int)this._customAttributeInfo.MaxValue)
                    {
                        outOfRange = true;
                    }
                }
            ...
            if (this._customAttributeInfo.MinValue != null)
            {
                ...
                if (value is float v)
                {
                    if (v < (float)this._customAttributeInfo.MinValue)
                    {
                        outOfRange = true;
                    }
                }
                ...
                {
                    if (v1 < (double)this._customAttributeInfo.MinValue)
                    {
                        outOfRange = true;
                    }
                }
                ...
                {
                    if (v2 < (int)this._customAttributeInfo.MinValue)
                    {
                        outOfRange = true;
                    }
                }
...
internal sealed class DynamicPropertyDescriptor : PropertyDescriptor
{
    ...
    /// </summary>
    public override bool IsBrowsable => this._basePropertyDescriptor.IsBrowsable;

    /// <summary>
    /// Gets a value indicating whether this property is read-only.
    /// </summary>
    public override bool IsReadOnly => this._basePropertyDescriptor.IsReadOnly;
