...
internal class ThreeLineBreakChart : IChartType
{
    ...
    internal static void PrepareData(Series series)
    {
        ...
        if (!string.Equals(series.ChartTypeName, ChartTypeNames.ThreeLineBreak, StringComparison.OrdinalIgnoreCase) || !series.IsVisible())
        {
            return;
        }
                ...
                else
                {
                    ...
                    if (sameDirectionLines >= linesInBreak)
                    {
                        if (direction == 1)
                        {
                            ...
                            {
                                if (highLowHistory[index] > lineBreakHigh)
                                {
                                    lineBreakHigh = highLowHistory[index];
                                }
                            }
                        ...
                        else if (direction == -1)
                        {
                            ...
                            {
                                if (highLowHistory[index] < lineBreakLow)
                                {
                                    lineBreakLow = highLowHistory[index];
                                }
                            }
    ...
    /// Chart type name
    /// </summary>
    public virtual string Name => ChartTypeNames.ThreeLineBreak;
