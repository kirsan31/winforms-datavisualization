...
/// </summary>
internal sealed class HundredPercentStackedColumnChart : StackedColumnChart
{
    #region Constructor
    ...
    /// Chart type name
    /// </summary>
    public override string Name => ChartTypeNames.OneHundredPercentStackedColumn;
...
internal class StackedColumnChart : IChartType
{
    ...
    /// </summary>
    internal List<string> stackGroupNames;
    ...
    /// Chart type name
    /// </summary>
    public virtual string Name => ChartTypeNames.StackedColumn;
        ...
        Series seriesToDraw)
    {
        ...
        if (differentAxesAreUsed)
        {
            for (int seriesIndex = 0; seriesIndex < common.DataManager.Series.Count; seriesIndex++)
            {
                ...
                // Set new group name
                string stackGroupName = "_X_" + ser.XAxisType.ToString() + ser.XSubAxisName + "_Y_" + ser.YAxisType.ToString() + ser.YSubAxisName + "__";
        ...
        for (int pointIndx = 0; pointIndx < maxNumOfPoints; pointIndx++)
        {
            ...
            for (int groupIndex = 0; groupIndex < this.stackGroupNames.Count; groupIndex++)
            {
                ...
                this.currentStackGroup = this.stackGroupNames[groupIndex];
        ...
        Series seriesToDraw)
    {
        ...
        foreach (DataPoint3D pointEx in dataPointDrawingOrder)
        {
            ...
            this.currentStackGroup = GetSeriesStackGroupName(ser);
