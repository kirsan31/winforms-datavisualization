...
internal class SplineChart : LineChart
{
    ...
    /// Chart type name
    /// </summary>
    public override string Name => ChartTypeNames.Spline;
...
internal class LineChart : PointChart
{
    ...
    /// <summary>
    /// Indicates that border color attribute must be used to draw the line
    /// </summary>
    protected bool useBorderColor;

    /// <summary>
    /// Indicates that line shadow should not be drawn
    /// </summary>
    protected bool disableShadow;

    /// <summary>
    /// Indicates that only line shadow must be drawn
    /// </summary>
    ...
    /// <summary>
    /// Indicates that lines outside the area should be still processed while drawing.
    /// </summary>
    ...
    /// Chart type name
    /// </summary>
    public override string Name => ChartTypeNames.Line;
    ...
    /// <summary>
    /// True if chart type supports axises
    /// </summary>
        ...
        float bottomDarkening)
    {
            ...
            (decimal)secondPoint.yPosition > plotAreaPositionBottom)
        {
            ...
            {
                Draw3DSurface(firstPoint, secondPoint, reversed,
        ...
        float bottomDarkening)
    {
        ...
        //****************************************************************
        int decimals = 3;
        Math.Round((decimal)area.PlotAreaPosition.X, decimals);
        decimal plotAreaPositionY = Math.Round((decimal)area.PlotAreaPosition.Y, decimals);
        Math.Round((decimal)area.PlotAreaPosition.Right, decimals);
        decimal plotAreaPositionBottom = Math.Round((decimal)area.PlotAreaPosition.Bottom, decimals);
