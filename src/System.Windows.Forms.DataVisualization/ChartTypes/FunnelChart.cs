...
//				equals 100% when totaled. This type of chart is a 
...
internal class FunnelChart : IChartType
{
    ...
    // Calculated plotting area of the chart
    ...
    /// <summary>
    /// Gets or sets the calculated plotting area of the chart 
    /// </summary>
    internal RectangleF PlotAreaPosition
    {
        get => _plotAreaPosition;
    ...
    /// Chart type name
    /// </summary>
    public virtual string Name => ChartTypeNames.Funnel;
        ...
        if (this._chartTypeSeries == null)
        {
            ...
            foreach (Series series in Common.DataManager.Series)
            {
                    ...
                    series.ChartArea == this.Area.Name)
                {
                    ...
                    if (string.Equals(series.ChartTypeName, this.Name, StringComparison.OrdinalIgnoreCase))
                    {
                        funnelSeries ??= series;
                    }
...
internal sealed class PyramidChart : FunnelChart
{
    ...
    /// Chart type name
    /// </summary>
    public override string Name => ChartTypeNames.Pyramid;
        ...
        out float endWidth)
    {
        ...
        // Get segment start and end width
        startWidth = Math.Abs(plotAreaPositionAbs.X + plotAreaPositionAbs.Width / 2f -
            startIntersection.X) * 2f;
        endWidth = Math.Abs(plotAreaPositionAbs.X + plotAreaPositionAbs.Width / 2f -
            endIntersection.X) * 2f;
