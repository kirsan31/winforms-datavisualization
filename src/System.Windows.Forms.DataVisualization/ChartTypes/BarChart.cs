...
internal sealed class RangeBarChart : BarChart
{
    ...
    /// Chart type name
    /// </summary>
    public override string Name => ChartTypeNames.RangeBar;
...
internal class BarChart : IChartType
{
    ...
    /// Chart type name
    /// </summary>
    public virtual string Name => ChartTypeNames.Bar;
        ...
        Series seriesToDraw)
    {
        ...
        foreach (Series ser in common.DataManager.Series)
        {
            ...
            if (!string.Equals(ser.ChartTypeName, Name, StringComparison.OrdinalIgnoreCase)
    ...
    private static int GetAdjustedPixelSize(int pixelSize, ChartGraphics graph)
    {
        if (graph != null && graph.Graphics != null)
        {
            ...
            {
                Width = pixelSize * graph.Graphics.DpiX * Chart.DPIScale / 96,
                Height = pixelSize * graph.Graphics.DpiY * Chart.DPIScale / 96
            };
