...
/// </summary>
internal sealed class HundredPercentStackedAreaChart : StackedAreaChart
{
    #region Constructor
    ...
    /// Chart type name
    /// </summary>
    public override string Name => ChartTypeNames.OneHundredPercentStackedArea;
...
internal class StackedAreaChart : AreaChart
{
    ...
    /// Chart type name
    /// </summary>
    public override string Name => ChartTypeNames.StackedArea;
        ...
        bool clippedSegment)
    {
        ...
        {
            DataPoint3D pointEx = points[pointIndex];
