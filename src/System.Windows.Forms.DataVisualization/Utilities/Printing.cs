            ...
            if (_chartImage != null)
            {
                ...
                try
                {
                    ...
                    if (ev.Graphics.PageUnit != GraphicsUnit.Pixel)
                    {
                        ...
                        marginPixel.X = (int)(marginPixel.X * (ev.Graphics.DpiX * Chart.DPIScale / 100.0f));
                        marginPixel.Y = (int)(marginPixel.Y * (ev.Graphics.DpiY * Chart.DPIScale / 100.0f));
                        marginPixel.Width = (int)(marginPixel.Width * (ev.Graphics.DpiX * Chart.DPIScale / 100.0f));
                        marginPixel.Height = (int)(marginPixel.Height * (ev.Graphics.DpiY * Chart.DPIScale / 100.0f));
                    }
